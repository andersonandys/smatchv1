...
class _GlobalSettingPageState extends State<GlobalSettingPage> {
  ...
  void initState() {
    ...
    if (ZegoUserHelper.instance.userID.isNotEmpty) {
      _userIDEdController.text = ZegoUserHelper.instance.userID;
    }

    _userNameEdController.text = ZegoUserHelper.instance.userName;
  ...
  void _onSaveButtonClicked() {
    ...
    ZegoUserHelper.instance.userName = userName;
    ZegoUserHelper.instance.userID = userID;
  ...
  bool get _needAskSave {
    ...
    if (!needAskSave && userID != ZegoUserHelper.instance.userID) {
      needAskSave = true;
    }
    if (!needAskSave && userName != ZegoUserHelper.instance.userName) {
      needAskSave = true;
    }
