...
class Favoris1shop extends StatefulWidget {
  const Favoris1shop({Key? key}) : super(key: key);

  @override
  _Favoris1shopState createState() => _Favoris1shopState();
}

class _Favoris1shopState extends State<Favoris1shop> {
